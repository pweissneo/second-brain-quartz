...
- **Schema version** — tracks metadata schema evolution, not knowledge validity
- **Correction workflow** — handles outdated knowledge reactively
- **Gap identification** — can leverage validity bounds for proactive tracking
