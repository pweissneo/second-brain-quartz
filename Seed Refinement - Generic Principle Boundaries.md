...
- **Operational vs. content**: CLAUDE.md, HEARTBEAT.md are operational (excluded from count), domain content is operational (included in count)
...
- [ ] Rule added to Seed (this refinement proposes)
