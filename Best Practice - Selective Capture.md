...
> 
> **Note (2026-04-01):** Anti-Pattern - Note Hoarding has been merged here — the anti-pattern file has been removed. This note now contains both the positive guidance and the failure mode it prevents.
...
See [[Anti-Pattern - Note Hoarding]] (merged, file removed) for what happens when this separation breaks down.
