...
The Seed now includes `framework-selection` metadata for major decisions. When documenting decisions, apply these filters in order:

### 1. Reversibility as Primary Filter
