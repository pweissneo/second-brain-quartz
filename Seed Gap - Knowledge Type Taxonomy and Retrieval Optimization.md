...
## Why This Is a Gap (Not Yet Resolved)

- No existing Seed rule addresses knowledge type taxonomy
- Note Types and Templates exists but isn't elevated to Seed-level principle
- The gap affects retrieval quality, not just structure
- Most domain-specific stress tests would reveal this gap if applied to knowledge type organization
