...
- Extends: Rule at line 2051 (scope metadata)
- Complements: Rule at line 935 (critical knowledge exemption in high-stakes domains)
- Complements: Rule at line 3357 (knowledge-modalities for multi-modal domains)

## Test Scenario

A vault about canine cardiology:
...
If a note about "NSAID safety in dogs" is applied to cats without a warning note, the vault has a safety gap.
