...
resolved-by: [[Frontier Exploration - Knowledge Presentation Calibration]]
---

# Frontier Exploration - Knowledge Calibration by Use Intent

> ⚠️ **DEPRECATED**: This note's content has been merged into [[Frontier Exploration - Knowledge Presentation Calibration]], which addresses both knowledge *quality* calibration AND use-intent calibration in a unified framework.
