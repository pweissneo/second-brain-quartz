...
knowledge-intent: technical
problem-type: verification
problem-domain: implementation
data-provenance:
  data-range: "1928-2023"
  data-source: "Multiple (NYU Stern, Shiller, Morningstar)"
  applicability-transferability: high
validity-scopes-known:
  - context: temporal
    note: "Claims depend heavily on time period selected"
  - context: source
    note: "Different databases give different numbers"
  - context: inflation
    note: "Nominal vs real returns differ substantially"
  - context: geographic
    note: "Geographic scope affects results"
tags:
  - seed-stress-test
  - financial-data
  - data-provenance
