...
- **Status**: identified → analyzed → merged into sibling
- **Integration note**: This gap was developed in parallel with [[Seed Gap - Staleness Detection vs. Staleness Computation]], which has since absorbed this content. The sibling note contains the more complete integration with full Rule/Why/Test format and schema. This note is now superseded but retained for historical reference.
